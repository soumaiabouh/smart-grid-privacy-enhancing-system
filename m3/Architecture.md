...
## 5. Stakeholders
The companies that own the smart meters would be using our system. They would implement our system between the data flow from the smart meters to their database. If we were to look at the whole process, there are also users that get involved by providing data, but they do not use our system, they provide data to our system.

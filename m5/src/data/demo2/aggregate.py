...
def aggregate_and_save_data(file_path, output_file_path):
    ...
    # Convert the readings from W to kW by dividing by 1000
    ...
    # Sum the data over 6-hour periods
    aggregated_data = data.resample('6H').sum()
...
for i in range(1, 11):
    ...
    output_file_path = f'apart{i}.xlsx'  # Output file with kW in the name for clarity
